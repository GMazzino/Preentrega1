...
module.exports.Products = class Products {
    ...
    addNewProduct(product){
        if( product.code != undefined && product.code != "" &&
            product.dateTime != undefined && product.dateTime != "" &&
            product.name != undefined && product.name != "" &&
            product.description != undefined && product.description != "" &&
            product.price != undefined && !isNaN(product.price) &&
            product.imgURL != undefined && product.imgURL != "" &&
            product.stock != undefined && !isNaN(product.stock)) {
                Products.#maxId = products.reduce((max, next) => Math.max(max, parseInt(next.id)),Products.#maxId);
